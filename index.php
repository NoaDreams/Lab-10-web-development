...
<head>
    ...
    <style>
        body {
            font-family: 'Segoe UI', Georgia, Lato, Verdana, Open Sans;
            line-height: 1.6;
            max-width: 1200px;
            margin: 0 auto;
            padding: 20px;
        ...
        h1 {
            border-bottom: 3px solid #241f3b;
            padding-bottom: 10px;
        }
        .container {
            display: grid;
        ...
        .card h3 {
            margin-top: 0;
            border-bottom: 2px solid #241f3b;
            padding-bottom: 10px;
        }
        img {
            max-width: 100%;
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="code-block">
                ...
                $black = imagecolorallocate($image, 0, 0, 0);<br>
                $font = 'fonts/Arimo-Regular.ttf';<br>
